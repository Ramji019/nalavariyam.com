...
var hanSearchContactsResult = function(btn)
{
	...
	storSearchContact.load({params: {searchName:strContactName, designation:strDesignation}});
...
var hanCBSViewContactDetails = function(grid, rowIndex, colIndex)
{
	...
	winViewContactDetails.setTitle(strTitle);
...
var hanCBSViewOpportunieyByContact = function(grid, rowIndex, colIndex)
{
	...
	winCBSViewOpportunityLisForContact.setTitle(strTitle);
