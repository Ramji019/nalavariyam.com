...
function deleteAllOpportunity(opportunityList, opportunityValue, opportunityDescription, contactEmail, publishingDate, docDeadlineDate, adDeadlineDate)
{
	var i;
	opportunityList.options[opportunityList.options.length] = new Option("", "nothing");
	var outLength = opportunityList.length
...
function clearOpportunity(opportunityList, opportunityValue, opportunityDescription, contactEmail, publishingDate, docDeadlineDate, adDeadlineDate)
{
	var i;
	opportunityList.options[opportunityList.options.length] = new Option("", "nothing");
	var outLength = opportunityList.length
	...
	for (i=0; i<outLength; i++)
	{
	    opportunityList.options[i].selected = false;
	}
